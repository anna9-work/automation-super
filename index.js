...
async function lineHandler(req, res) {
  try {
    ...
    try {
      return res.status(200).send('OK'); // 即使錯也回 200，避免 LINE 一直重送
    } catch {}
  }
}
